// src/components/editcommunity/ImageCroppers.tsx
...
const ImageCropper: React.FC<ImageCropperProps> = ({ file, onCropComplete, onClose, aspectRatio, maxWidth }) => {
  ...
  const handleCropSave = async () => {
    const croppedImageUrl = await getCroppedImg(URL.createObjectURL(file), croppedAreaPixels, maxWidth);
    onCropComplete(croppedImageUrl); // Send cropped image back to parent
